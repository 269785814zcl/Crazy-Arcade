...
def select_player_number(screen):
	...
	while True:  #选择玩家数量循环
		...
		text_number = text_font.render ("游戏开始请选择玩家数量",True,(255,255,255))
		text_number1 = text_font.render ("·······一个玩家",True,(255,255,255))
		text_number2 = text_font.render ("·······两个玩家",True,(255,255,255))
		text_number3 = text_font.render ("·······三个玩家",True,(255,255,255))
		text_number4 = text_font.render ("·······四个玩家",True,(255,255,255))
